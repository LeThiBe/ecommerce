...
ActiveRecord::Schema.define(version: 20180928075051) do
  ...
  create_table "order_details", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order_product_id"], name: "index_order_details_on_order_product_id"
  ...
  add_foreign_key "order_details", "order_products"
